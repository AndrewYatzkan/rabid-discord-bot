...
class Database {
    constructor() {
        ...
        this.mongoose.connect(connectionString, { useNewUrlParser: true, useUnifiedTopology: true });
        this.mongoose.connection.on('error', e => { Log.error(0, "Database >> Connection failed (", e, ")"); });
        this.mongoose.connection.once('open', () => { Log.important(0, "Database >> Successfully connected"); });
    }
